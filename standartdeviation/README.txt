...
her bir thread'e en az 2 eleman düşmesi için thread sayısı dizi eleman sayısının yarısından kücük olmalıdır. 
4-her bir threadin bulduğu sonuçlar ve total sonuç dökümanda bir backend kodu istenmediği için console'a yazdırılmıştır. 